...
import logo from './logo.png'; // Adjust the path to your logo image file (e.g., in src/assets/logo.png)
import logo2 from './logo2.png'; // Optional: another logo for features preview
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name || !email || !password || !confirmPassword) {
      toast.error('Please fill in all fields', {
        style: { background: '#1e293b', color: '#fff', border: '1px solid #dc2626' },
      });
      return;
    }
    ...
    try {
      const response = await fetch('https://bitecount-backend.onrender.com/register', {
        method: 'POST',
      ...
      if (response.ok) {
        ...
        toast.success(`Account created successful! ${name} 💪`, {
          style: { background: '#1e293b', color: '#fff', border: '1px solid #dc2626' },
        });
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Join the Nutrition Revolution</h2>
          <p className="text-gray-400">Create an account to start tracking your nutrition</p>
        </div>
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8 shadow-2xl backdrop-blur-sm">
          ...
          <div className="mt-8 pt-6 border-t border-slate-700">
            <p className="text-center text-gray-400">
              ...
              <Link to="/login" className="font-semibold text-red-400 hover:text-red-300 transition-colors duration-200 hover:underline">
                Sign In
              </Link>
            </p>
          </div>
